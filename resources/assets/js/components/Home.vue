            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 mx-auto text-center">
                        ...
                        <hr class="light my-4">
                        <p class="text-faded mb-4">T-Games has every piece of functionality you want to match with other gamers online! Our patent pending matchmaking algorithm allows you to match with gamers from all around the world.   No strings attached!</p>
